    ...
    <div className="mattress-plp-page">
      ...
      <section className="plp-hero plp-hero-fullbleed">
        <div className="plp-hero-slide">
          <img src="/images/generated/mattress_hero_ai.jpg" alt="Mattress" className="plp-hero-bg-img" />
          <div className="plp-hero-overlay">
            <div className="plp-hero-content">
              <h1 className="plp-hero-title">Mattress</h1>
              <p className="plp-hero-desc">
                Discover the secret to deep, restful sleep! Experience unparalleled comfort and support with our revolutionary mattress. Wakeup refresh and ready to beat the day!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="plp-layout">
            ...
            <aside className={`plp-sidebar ${showFilter ? 'open' : ''}`}>
              ...
              <div className="plp-filter-block">
                ...
                <div className="plp-price-inputs">
                  ...
                  <div className="price-input">
                    <span>₹</span>
                    <input type="number" defaultValue="22914" />
                  </div>
                </div>
            ...
            <div className="plp-grid">
              {mattresses.map(product => {
                ...
                const discount = product.discount || 65;
          ...
          <div className="plp-explore-grid">
            <Link to="/bedsheet" className="plp-explore-item">
              <div className="explore-img-wrap">
                <img src="/images/generated/bedsheet_category.jpg" alt="Bedsheet" />
              </div>
              <h4>Bedsheet</h4>
            </Link>
            ...
            <Link to="/pillow" className="plp-explore-item">
              <div className="explore-img-wrap">
                <img src="/images/generated/pillow_category.png" alt="Pillow" />
              </div>
              <h4>Pillow</h4>
            </Link>
          </div>
