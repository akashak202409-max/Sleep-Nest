    ...
    <div className="mattress-plp-page">
      ...
      <section className="plp-hero plp-hero-fullbleed">
        <div className="plp-hero-slide">
          <img src="/images/generated/comforter_hero.jpg" alt="Comforter" className="plp-hero-bg-img" />
          <div className="plp-hero-overlay">
            <div className="plp-hero-content">
              <h1 className="plp-hero-title">Comforter</h1>
              <p className="plp-hero-desc">
                Experience cloud-like comfort and warmth with our plush, breathable comforters. Designed for all-season coziness to give you the perfect night's rest.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="plp-layout">
            ...
            <div className="plp-grid">
              {comforters.map(product => {
                ...
                const discount = product.discount || 35;
