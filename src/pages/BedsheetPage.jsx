    ...
    <div className="mattress-plp-page">
      ...
      <section className="plp-hero plp-hero-fullbleed">
        <div className="plp-hero-slide">
          <img src="/images/generated/bedsheet_hero.jpg" alt="Bedsheet" className="plp-hero-bg-img" />
          <div className="plp-hero-overlay">
            <div className="plp-hero-content">
              <h1 className="plp-hero-title">Bedsheet</h1>
              <p className="plp-hero-desc">
                Transform your sleep with our incredibly soft, breathable, and luxurious bedsheets. Made with premium fabrics for ultimate comfort and durability!
              </p>
            </div>
          </div>
        </div>
            ...
            <aside className={`plp-sidebar ${showFilter ? 'open' : ''}`}>
              ...
              <div className="plp-filter-block">
                ...
                <div className="plp-price-inputs">
                  ...
                  <div className="price-input">
                    <span>₹</span>
                    <input type="number" defaultValue="5999" />
                  </div>
                </div>
